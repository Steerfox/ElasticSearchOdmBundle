...
namespace Steerfox\ElasticsearchBundle\Tests\Unit;

use Steerfox\ElasticsearchBundle\SteerfoxElasticsearchBundle;
...
/**
 * Unit test for Steerfox\ElasticsearchBundle.
 */
class ElasticsearchBundleTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPassesRegistered()
    {
        ...
        $bundle = new SteerfoxElasticsearchBundle();
