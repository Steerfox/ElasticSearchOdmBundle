...
namespace Steerfox\ElasticsearchBundle\Tests\Unit\Result\Aggregation;

use Steerfox\ElasticsearchBundle\Result\Aggregation\AggregationValue;
...
class AggregationValueTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetBuckets()
    {
        ...
        foreach ($buckets as $bucket) {
            $this->assertInstanceOf('\Steerfox\ElasticsearchBundle\Result\Aggregation\AggregationValue', $bucket);
        }
    }
    ...
    public function testGetAggregation()
    {
        ...
        $this->assertInstanceOf(
            '\Steerfox\ElasticsearchBundle\Result\Aggregation\AggregationValue',
