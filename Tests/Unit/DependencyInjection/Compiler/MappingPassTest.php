...
namespace Steerfox\ElasticsearchBundle\Tests\Unit\DependencyInjection\Compiler;
...
class MappingPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $metadataCollectorMock = $this->getMockBuilder('Steerfox\ElasticsearchBundle\Mapping\MetadataCollector')
