...
namespace Steerfox\ElasticsearchBundle\Tests\Unit\DependencyInjection;

use Steerfox\ElasticsearchBundle\DependencyInjection\SteerfoxElasticsearchExtension;
...
class ElasticsearchExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoad($parameters, $expectedManagers)
    {
        ...
        $extension = new SteerfoxElasticsearchExtension();
        $extension->load(
            $parameters,
            $container
        );
