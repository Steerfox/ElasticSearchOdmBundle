...
namespace Steerfox\ElasticsearchBundle\Tests\Unit\Generator;

use Steerfox\ElasticsearchBundle\Generator\DocumentGenerator;
use Steerfox\ElasticsearchBundle\Service\GenerateService;
...
class GenerateServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->tmpDir = sys_get_temp_dir() . '/steerfox';
