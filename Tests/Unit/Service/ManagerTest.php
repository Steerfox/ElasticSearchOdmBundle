...
class ManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getPreparedConfiguration()
    {
        ...
        $manager = new Manager(
            ...
            $this->createMock('Steerfox\ElasticsearchBundle\Mapping\MetadataCollector'),
            $this->createMock('Steerfox\ElasticsearchBundle\Result\Converter')
        );
