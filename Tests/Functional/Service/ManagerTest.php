...
namespace Steerfox\ElasticsearchBundle\Tests\Functional\Service;

use Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Document\CategoryObject;
...
class ManagerTest extends AbstractElasticsearchTestCase
{
    ...
    public function getPersistExceptionsData()
    {
        ...
        $out[] = [
            ...
            'got Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Document\Product.',
        ];
        ...
        $out[] = [
            $product,
            'Expected object of type ' .
            'Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Document\CategoryObject, got stdClass.',
        ];
    ...
    public function testGetRepository()
    {
        ...
        $this->assertInstanceOf('Steerfox\ElasticsearchBundle\Service\Repository', $repository);
    ...
    public function testRemove()
    {
        ...
        $this->assertInstanceOf('Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Document\Product', $product);
     ...
     *
     * @expectedException \Steerfox\ElasticsearchBundle\Exception\MissingDocumentAnnotationException
    ...
    public function testParseResultsWithDifferentResultTypes()
    {
        ...
        $this->assertInstanceOf('Steerfox\ElasticsearchBundle\Result\RawIterator', $products);
    }

    /**
     * Tests the exception thrown by the commit method
     *
     * @expectedException \Steerfox\ElasticsearchBundle\Exception\BulkWithErrorsException
     */
    ...
    public function testCustomManagerWithCustomMappingDir()
    {
        ...
        $category = new \Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Entity\CategoryObject();
        $category->title = 'foo';
        $product = new \Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Entity\Product();
        $product->id = 'custom';
        ...
        /** @var \Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Entity\Product $actualProduct */
