...
namespace Steerfox\ElasticsearchBundle\Tests\Functional;
...
class RepositoryTest extends AbstractElasticsearchTestCase
{
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('Steerfox\ElasticsearchBundle\Tests\app\fixture\TestBundle\Document\Product', $result);
    ...
    public function testRepositoryExecuteWhenZeroResult()
    {
        ...
        $this->assertInstanceOf(
            '\Steerfox\ElasticsearchBundle\Result\DocumentIterator',
            $searchResult
        );
