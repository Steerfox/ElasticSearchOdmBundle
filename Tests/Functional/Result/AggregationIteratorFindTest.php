...
class AggregationIteratorFindTest extends AbstractElasticsearchTestCase
{
    ...
    public function testIteration()
    {
        ...
        $this->assertInstanceOf('Steerfox\ElasticsearchBundle\Result\Aggregation\AggregationValue', $rangeResult);

        foreach ($rangeResult->getBuckets() as $aggKey => $subAgg) {
            $this->assertInstanceOf('Steerfox\ElasticsearchBundle\Result\Aggregation\AggregationValue', $subAgg);
