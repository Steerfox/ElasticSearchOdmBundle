...
Command name: `steerfox:es:index:create`
...
Command name: `steerfox:es:index:drop`
...
Command name: `steerfox:es:index:import <file-path>`
...
Command name: `steerfox:es:index:export <file-path>`
...
Command name: `steerfox:es:document:generate`

Steerfox ElasticsearchBundle supports automatic document generation. This command will present a user with a set of questions and when those questions are
...
Command name: `steerfox:es:cache:clear`
