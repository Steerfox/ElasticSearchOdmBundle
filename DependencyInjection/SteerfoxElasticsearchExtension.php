...
namespace Steerfox\ElasticsearchBundle\DependencyInjection;
 ...
 */
class SteerfoxElasticsearchExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $definition = new Definition(
            'Steerfox\ElasticsearchBundle\Service\ManagerFactory',
            [
