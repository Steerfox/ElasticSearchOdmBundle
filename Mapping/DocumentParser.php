...
use Steerfox\ElasticsearchBundle\Annotation\Document;
use Steerfox\ElasticsearchBundle\Annotation\Embedded;
use Steerfox\ElasticsearchBundle\Annotation\HashMap;
use Steerfox\ElasticsearchBundle\Annotation\MetaField;
use Steerfox\ElasticsearchBundle\Annotation\Nested;
use Steerfox\ElasticsearchBundle\Annotation\ParentDocument;
use Steerfox\ElasticsearchBundle\Annotation\Property;
use Steerfox\ElasticsearchBundle\Exception\MissingDocumentAnnotationException;
...
class DocumentParser
{
    ...
    // Meta fields
    const ID_ANNOTATION = 'Steerfox\ElasticsearchBundle\Annotation\Id';
    const PARENT_ANNOTATION = 'Steerfox\ElasticsearchBundle\Annotation\ParentDocument';
    const ROUTING_ANNOTATION = 'Steerfox\ElasticsearchBundle\Annotation\Routing';
    const VERSION_ANNOTATION = 'Steerfox\ElasticsearchBundle\Annotation\Version';
    const HASH_MAP_ANNOTATION = 'Steerfox\ElasticsearchBundle\Annotation\HashMap';
