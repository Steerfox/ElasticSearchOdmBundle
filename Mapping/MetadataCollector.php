...
use Steerfox\ElasticsearchBundle\Exception\DocumentParserException;
...
class MetadataCollector
{
    ...
    public function getBundleMapping($name, $config = [])
    {
        ...
        $cacheName =  'steerfox.metadata.mapping.' . md5($name.serialize($config));
    ...
    {
        $cacheName = 'steerfox.metadata.analysis.'.md5(serialize($bundles));
    ...
    {
        $cacheName = 'steerfox.metadata.document.'.md5($namespace);
