...
- Added `Steerfox\ElasticsearchBundle\Exception` namespace.
...
## v1.1.1 (2016-05-26)
- Added sub-folder for elasticsearch mappings cache due conflict with other Steerfox bundles.
- Changed the default value for steerfox cache to %kernel.debug% #637
- By default es manager always refresh and flush only the current index #638

## v1.1.0 (2016-05-26)
- Introduced documents generator. Check the new `steerfox:es:document:generate` command. #601
