...
namespace Steerfox\ElasticsearchBundle\Generator;
 ...
 */'
    ...
    {
        $uses = ['use Steerfox\ElasticsearchBundle\Annotation as ES;'];

        if ($this->hasMultipleEmbedded($metadata)) {
            $uses[] = 'use Steerfox\ElasticsearchBundle\Collection\Collection;';
        }
