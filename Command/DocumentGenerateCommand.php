...
class DocumentGenerateCommand extends AbstractManagerAwareCommand
{
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('steerfox:es:document:generate')
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(
            [
                ...
                '',
                'This command helps you generate SteerfoxElasticsearchBundle documents.',
                '',
    ...
    {
        $reflection = new \ReflectionClass('Steerfox\ElasticsearchBundle\Annotation\Property');
